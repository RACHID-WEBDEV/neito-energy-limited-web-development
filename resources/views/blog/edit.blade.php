      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="breadcroumb-title">
            <h1>Edit Blog</h1>
            <h6><a href="/blog">Blog</a> / Edit Blog</h6>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-8 offset-lg-2 text-center">
          <div class="section-title">
            ...
            <h2> Edit <b>Blog Post</b></h2>
          </div>
        </div>
      </div>
      <div class="quotation-block">
        <form  class="quotation-form" action="{{route('blog.update', $post->slug)}}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
          @method('PUT') 
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="form-group">
                ...
                <input type="file" name="image" id="" value="{{$post->image}}" accept="image/*" onchange="document.getElementById('show_img').src = window.URL.createObjectURL(this.files[0])" >
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-lg-4">
              <div class="form-group">
                ...
                <div class="form-group">
                  <img  id="show_img" src="/storage/images/{{$post->image}}" height="300px" width="300px" />
               </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-8">
              <div class="form-group">
                ...
                <div class="form-group">
                  <select class="form-control" name="cat_id" value="{{$post->cat_id}}" id="">
                    <?php
            ...
            <div class="col-lg-4">
              <div class="request-button">
                <button type="submit" class="main-btn">Update Post<i class="las la-arrow-right"></i></button>
              </div>
            </div>
          </div>
